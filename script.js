...
const contenidoSemanas = {
  ...
  7: `
    ...
    <button class="custom-button" onclick="window.open('https://www.canva.com/design/DAG2hSK7urQ/-efxqf8fd2QmLai-_JLjqA/view?utm_content=DAG2hSK7urQ&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h2690030ce0', '_blank')">
      🗄️ Manual QHATUPERU
    </button>
